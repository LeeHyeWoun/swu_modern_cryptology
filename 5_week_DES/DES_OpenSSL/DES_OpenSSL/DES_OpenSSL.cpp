...
int main()
{
	...
	DES_cbc_encrypt( ( unsigned char* )input_data, ( unsigned char* )cipher, sizeof( input_data ), &SchKey1, &iv, DES_ENCRYPT );
	...
	DES_cbc_encrypt( ( unsigned char* )cipher, ( unsigned char* )text, sizeof( input_data ), &SchKey1, &iv, DES_DECRYPT );
